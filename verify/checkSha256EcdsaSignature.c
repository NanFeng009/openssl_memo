...
/*
 * SGX
 * xxd -ps -l0x1b0 -i quote.dat >msg.dat
 * xxd -ps -s0x1f4 -l0x40 -i quote.dat >key.dat
 * xxd -ps -s0x1b4 -l0x40 -i quote.dat >sig.dat
 * or for qe_enclave_report
 * xxd -ps -s0x3b4 -l0x40 -i quote.dat >sig.dat
 * xxd -ps -s0x234 -l0x180 -i quote.dat >msg.da
 */
int main()
{
		EVP_MD_CTX *ctx = NULL;
...
#include "msg.dat"
		...
		// BN_lebin2bn(sig, 32, bnR);
		// BN_lebin2bn(sig + 32, 32, bnS);
