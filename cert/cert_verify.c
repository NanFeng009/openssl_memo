 ...
 *openssl verify -show_chain -verbose -CAfile <(cat r3.cer root.cer ) cert.cer
 *openssl verify -CAfile root.cer -untrusted r3.cer cert.pem
 * #verify cert against crl(ocsp)
 *openssl ocsp -issuer r3.cer -cert cert.pem -text -url http://r3.o.lencr.org
 *openssl ocsp -issuer r3.cer -cert cert.pem -text -url http://r3.o.lencr.org
 *
 * cat r3.cer root.cer >ca-bundle.pem
 * cp cert.cer cert-file.pem
 * gcc -o certverify cert_verify.c -lcrypto
 *
